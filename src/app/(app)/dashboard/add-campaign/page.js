                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg w-full md:w-1/2 relative">
                        ...
                        {loading && (
                            <div className="absolute inset-0 bg-gray-100 bg-opacity-75 flex items-center justify-center z-10">
                                <div role="status">
                                    <svg aria-hidden="true" className="w-12 h-12 text-gray-300 animate-spin dark:text-gray-800 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="p-6 bg-white border-b border-gray-200">
                            ...
                            <form onSubmit={submitForm}>
                                ...
                                <div className="mt-4">
                                    ...
                                    <InputError messages={errors.emailAddress} className="mt-2" />
                                </div>
                                ...
                                <div className="mt-4">
                                    ...
                                    <InputError messages={errors.contactName} className="mt-2" />
                                </div>
